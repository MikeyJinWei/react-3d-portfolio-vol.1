...
export const experiences = [
  {
    ...
    points: [
      '網頁管理：建置公司網頁（自行開發、發包管理）、定期由後台上傳施工進度（至網頁）',
      '規劃：目標市場分析、參與平面規劃、討論建材選用、參與建築外觀／公設／景觀設計',
      '行銷/銷售：參與推案行銷會議、官方 LINE 帳號管理（撰寫自動回覆訊息, 圖文案上架）、整理/撰寫建材清單',
      '工程：協助現場施工端對圖 (AutoCAD)、現勘協助監督設備安裝（公設設施, 衛浴, 廚具, 室裝, 擺設）、拍照留存竣工照片',
      '行政：整理/撰寫送審公文 (Excel, PowerPoint , Word, PDF)、施工詢/議價、合約協審/簽署、核對施工進度請款（與會計人員/工地主任溝通）、上傳報價/合約歸檔',
    ],
  },
  {
    title: '咖啡店專櫃人員/吧台人員',
